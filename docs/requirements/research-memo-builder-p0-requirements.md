...
| ID         | ケース                   | 処理                    | exit code |
| ---------- | ------------------------ | ----------------------- | --------: |
| P0-ERR-001 | `BRAVE_API_KEY` 未設定   | API呼び出し前に停止する |         3 |
| P0-ERR-002 | 入力ファイル未指定       | 停止する                |         2 |
| P0-ERR-003 | 入力ファイルが存在しない | 停止する                |         2 |
| P0-ERR-004 | YAMLパース失敗           | 停止する                |         2 |
| P0-ERR-005 | 必須項目不足             | 停止する                |         2 |
| P0-ERR-006 | 入力値不正               | 停止する                |         2 |
| P0-ERR-007 | 出力ディレクトリ作成失敗 | 停止する                |         5 |
| P0-ERR-008 | ファイル書き込み失敗     | 停止する                |         5 |
